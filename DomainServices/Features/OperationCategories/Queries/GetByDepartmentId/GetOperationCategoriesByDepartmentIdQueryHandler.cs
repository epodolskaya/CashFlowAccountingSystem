...
public class GetOperationCategoriesByDepartmentIdQueryHandler : IRequestHandler<GetOperationCategoriesByDepartmentIdQuery, ICollection<OperationCategory>>
{
    ...
    public async Task<ICollection<OperationCategory>> Handle(GetOperationCategoriesByDepartmentIdQuery request, CancellationToken cancellationToken)
    {
